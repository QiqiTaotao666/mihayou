#ifndef STARGATE_HLSL_INCLUDED
#define STARGATE_HLSL_INCLUDED

// Photoshop-style Overlay blend
// if base <= 0.5: 2 * base * blend
// if base >  0.5: 1 - 2 * (1 - base) * (1 - blend)
half OverlaySingle(half base, half blend)
{
    return (base <= 0.5)
        ? 2.0 * base * blend
...
// Scalar overload
half Overlay(half base, half blend)
{
    return OverlaySingle(base, blend);
}

#endif // STARGATE_HLSL_INCLUDED
