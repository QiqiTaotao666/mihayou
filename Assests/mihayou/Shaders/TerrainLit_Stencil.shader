Shader "Universal Render Pipeline/Terrain/Lit (Stencil)"
{
    Properties
    {
    ...
    Dependency "AddPassShader" = "Hidden/Universal Render Pipeline/Terrain/Lit (Add Pass Stencil)"
    Dependency "BaseMapShader" = "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass Stencil)"
